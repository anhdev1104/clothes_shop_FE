  ...
  const addToCart = e => {
    ...
    if (innerSize === '') {
      return Toast(toastRef, {
        title: 'Thất bại !',
        message: 'Vui lòng chọn size của sản phẩm.',
        type: 'error',
        duration: 3000,
      });
    }
    ...
    if (localStorage.getItem('cart') !== null) {
      ...
      const existingProductIndex = cart.findIndex(
        item => item.name === productCart.name && item.size === productCart.size
      );
      if (existingProductIndex !== -1) {
        cart[existingProductIndex].quantity += productCart.quantity;
      } else {
    ...
    <>
      ...
      <main className="container-page">
        <section className="mt-[110px]">
          <form onSubmit={addToCart} action="" method="POST" id="addCartForm">
              ...
              <div className="w-[50%]">
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    >
                      ...
                      <img src="../src/assets/images/boxsize.jpg" alt="" className="w-full h-full" />
                    </div>
                  </div>
                </div>
                ...
                <div className="py-[25px]">
                  ...
                  <p className="mb-5 leading-6 font-light">
                    Màu sắc sản phẩm có thể sẽ chênh lệch thực tế một phần nhỏ, do ảnh hưởng về độ lệch màu của ánh sáng
